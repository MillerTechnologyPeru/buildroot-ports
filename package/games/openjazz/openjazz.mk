...
define OPENJAZZ_POST_PROCESS
	...
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/openjazz/openjazz.keys $(TARGET_DIR)/usr/share/evmapy
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/openjazz/openjazz.cfg $(TARGET_DIR)/usr/share/batocera/datainit/system/configs/openjazz.cfg
endef
