...
define GZDOOM_COPY_GENERATED_HEADERS
	...
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/gzdoom/arith_$(GZDOOM_GENERATED_HEADER_SUFFIX).h \
	    $(GZDOOM_BUILDDIR)/libraries/gdtoa/arith.h
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/gzdoom/gd_qnan_$(GZDOOM_GENERATED_HEADER_SUFFIX).h \
...
ifneq ($(BR2_PACKAGE_SWIFTLINUXPORTS_TARGET_X86_64_ANY),y)
...
define GZDOOM_INSTALL_TARGET_CMDS
	...
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/gzdoom/gzdoom.keys \
