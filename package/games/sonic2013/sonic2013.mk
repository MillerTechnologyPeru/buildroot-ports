...
ifeq ($(BR2_PACKAGE_SWIFTLINUXPORTS_TARGET_X86_ANY),y)
...
define SONIC2013_POST_PROCESS
	...
	cp -f $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/sonic2013/sonicretro.keys $(TARGET_DIR)/usr/share/evmapy
endef
