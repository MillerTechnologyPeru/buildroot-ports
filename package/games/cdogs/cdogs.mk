...
define CDOGS_INSTALL_TARGET_CMDS
    ...
    cp -f $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/cdogs/gamecontrollerdb.txt $(TARGET_DIR)/usr/share/batocera/datainit/roms/cdogs/data

    # evmap config
	mkdir -p $(TARGET_DIR)/usr/share/evmapy
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/cdogs/cdogs.keys $(TARGET_DIR)/usr/share/evmapy
endef
