...
define RAZE_COPY_GENERATED_HEADERS
	...
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/raze/arith_$(RAZE_GENERATED_HEADER_SUFFIX).h $(RAZE_BUILDDIR)/libraries/gdtoa/arith.h
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/raze/gd_qnan_$(RAZE_GENERATED_HEADER_SUFFIX).h $(RAZE_BUILDDIR)/libraries/gdtoa/gd_qnan.h
endef
...
ifeq ($(BR2_PACKAGE_SWIFTLINUXPORTS_GLES3)$(BR2_PACKAGE_SWIFTLINUXPORTS_GLES2),y)
...
define RAZE_INSTALL_TARGET_CMDS
    ...
    cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/raze/raze.keys $(TARGET_DIR)/usr/share/evmapy
endef
