...
define ECWOLF_COPY_GENERATED_HEADERS
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/ecwolf/arith_$(ECWOLF_GENERATED_HEADER_SUFFIX).h $(ECWOLF_BUILDDIR)/deps/gdtoa/arith.h
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/ecwolf/gd_qnan_$(ECWOLF_GENERATED_HEADER_SUFFIX).h $(ECWOLF_BUILDDIR)/deps/gdtoa/gd_qnan.h
endef
...
define ECWOLF_INSTALL_TARGET_CMDS
	...
	cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/ecwolf/ecwolf.keys $(TARGET_DIR)/usr/share/evmapy
endef
