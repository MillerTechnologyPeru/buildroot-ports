...
define EDUKE32_INSTALL_TARGET_CMDS
    ...
    cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/eduke32/eduke32.keys $(TARGET_DIR)/usr/share/evmapy
    cp $(BR2_EXTERNAL_SWIFTLINUXPORTS_PATH)/package/games/eduke32/eduke32.keys $(TARGET_DIR)/usr/share/evmapy/fury.keys
endef
